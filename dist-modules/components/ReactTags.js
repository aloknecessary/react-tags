  ...
  _createClass(ReactTags, [{
    ...
    value: function render() {
      ...
      var _props2 = this.props,
          ...
          maxTagCount = _props2.maxTagCount,
          tags = _props2.tags;


      var position = !inline ? _constants.INPUT_FIELD_POSITIONS.BOTTOM : inputFieldPosition;

      var tagInput = !this.props.readOnly ? tags.length < maxTagCount ? _react2.default.createElement(
        'div',
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: 'react-tags-count-container' },
          _react2.default.createElement(
            'div',
            { className: 'react-tags-count' },
            _react2.default.createElement(
              'span',
              null,
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.addTag = function (tag) {
    var _props3 = _this5.props,
        ...
        maxTagCount = _props3.maxTagCount;
  ...
  this.getTagItems = function () {
    ...
    return tags.map(function (tag, index) {
      return _react2.default.createElement(
        'div',
        { className: 'tag__container', key: index },
